import {_getTaskCardMarkup} from "./task-card";
import {_getCreateAndEditFormMarkup} from "./create-and-edit-form";
import {_getLoadMoreButtonMarkup} from "./load-more-button";
import {_getSortMarkup} from "./sort";
...
export const getLoadMoreButtonMarkup = _getLoadMoreButtonMarkup;
export const getSortMarkup = _getSortMarkup;
export const getFilterMarkup = _getFilterMarkup;
